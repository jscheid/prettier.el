  ...
  for (var loop = true; pos[0] < len && loop; pos[0]++) {
    ...
    switch (ch) {
      ...
      case goog.i18n.NumberFormat.PATTERN_EXPONENT_:
        ...
        if (
          pos[0] + 1 < len &&
          pattern.charAt(pos[0] + 1) == goog.i18n.NumberFormat.PATTERN_PLUS_
        ) {
          pos[0]++;
        ...
        if (
          digitLeftCount + zeroDigitCount < 1 ||
...
goog.i18n.NumberFormat.prototype.getUnitAfterRounding_ = function (
  ...
  var finalPlurality = this.pluralForm_(
    pluralityRounded.intValue + pluralityRounded.fracValue
  );
